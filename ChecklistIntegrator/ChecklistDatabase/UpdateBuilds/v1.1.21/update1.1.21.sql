  ...
  <xsl:template name="transTDWG">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$pSchema=''TDWG Level 3''">
        <xsl:choose>
          <xsl:when test="$pRegion=''DEN''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Denmark (DEN); L4:</xsl:when>
          <xsl:when test="$pRegion=''FIN''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Finland (FIN); L4:</xsl:when>
          <xsl:when test="$pRegion=''FOR''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Føroyar (FOR); L4:</xsl:when>
          <xsl:when test="$pRegion=''GRB''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Great Britain (GRB); L4:</xsl:when>
          <xsl:when test="$pRegion=''ICE''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Iceland (ICE); L4:</xsl:when>
          <xsl:when test="$pRegion=''IRE''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Ireland (IRE); L4:</xsl:when>
          <xsl:when test="$pRegion=''NOR''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Norway (NOR); L4:</xsl:when>
          <xsl:when test="$pRegion=''SVA''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Svalbard (SVA); L4:</xsl:when>
          <xsl:when test="$pRegion=''SWE''">L1: 1 - Europe; L2: 10 - Northern Europe; L3: Sweden (SWE); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''GER''">L1: 1 - Europe; L2: 11 - Middle Europe; L3: Germany (GER); L4:</xsl:when>
          <xsl:when test="$pRegion=''HUN''">L1: 1 - Europe; L2: 11 - Middle Europe; L3: Hungary (HUN); L4:</xsl:when>
          <xsl:when test="$pRegion=''NET''">L1: 1 - Europe; L2: 11 - Middle Europe; L3: Netherlands (NET); L4:</xsl:when>
          <xsl:when test="$pRegion=''POL''">L1: 1 - Europe; L2: 11 - Middle Europe; L3: Poland (POL); L4:</xsl:when>
          <xsl:when test="$pRegion=''SWI''">L1: 1 - Europe; L2: 11 - Middle Europe; L3: Switzerland (SWI); L4:</xsl:when>
          <xsl:when test="$pRegion=''BAL''">L1: 1 - Europe; L2: 12 - Southwestern Europe; L3: Baleares (BAL); L4:</xsl:when>
          <xsl:when test="$pRegion=''COR''">L1: 1 - Europe; L2: 12 - Southwestern Europe; L3: Corse (COR); L4:</xsl:when>
          <xsl:when test="$pRegion=''FRA''">L1: 1 - Europe; L2: 12 - Southwestern Europe; L3: France (FRA); L4:</xsl:when>
          <xsl:when test="$pRegion=''POR''">L1: 1 - Europe; L2: 12 - Southwestern Europe; L3: Portugal (POR); L4:</xsl:when>
          <xsl:when test="$pRegion=''SAR''">L1: 1 - Europe; L2: 12 - Southwestern Europe; L3: Sardegna (SAR); L4:</xsl:when>
          <xsl:when test="$pRegion=''SPA''">L1: 1 - Europe; L2: 12 - Southwestern Europe; L3: Spain (SPA); L4:</xsl:when>
          <xsl:when test="$pRegion=''ALB''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Albania (ALB); L4:</xsl:when>
          <xsl:when test="$pRegion=''BUL''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Bulgaria (BUL); L4:</xsl:when>
          <xsl:when test="$pRegion=''GRC''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Greece (GRC); L4:</xsl:when>
          <xsl:when test="$pRegion=''ITA''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Italy (ITA); L4:</xsl:when>
          <xsl:when test="$pRegion=''KRI''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Kriti (KRI); L4:</xsl:when>
          <xsl:when test="$pRegion=''ROM''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Romania (ROM); L4:</xsl:when>
          <xsl:when test="$pRegion=''SIC''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Sicilia (SIC); L4:</xsl:when>
          <xsl:when test="$pRegion=''TUE''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Turkey-in-Europe (TUE); L4:</xsl:when>
          <xsl:when test="$pRegion=''YUG''">L1: 1 - Europe; L2: 13 - Southeastern Europe; L3: Yugoslavia (YUG); L4:</xsl:when>
          <xsl:when test="$pRegion=''BLR''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: Belarus (BLR); L4:</xsl:when>
          <xsl:when test="$pRegion=''BLT''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: Baltic States (BLT); L4:</xsl:when>
          <xsl:when test="$pRegion=''KRY''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: Krym (KRY); L4:</xsl:when>
          <xsl:when test="$pRegion=''RUC''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: Central European Russia (RUC); L4:</xsl:when>
          <xsl:when test="$pRegion=''RUE''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: East European Russia (RUE); L4:</xsl:when>
          <xsl:when test="$pRegion=''RUN''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: North European Russia (RUN); L4:</xsl:when>
          <xsl:when test="$pRegion=''RUS''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: South European Russia (RUS); L4:</xsl:when>
          <xsl:when test="$pRegion=''RUW''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: Northwest European Russia (RUW); L4:</xsl:when>
          <xsl:when test="$pRegion=''UKR''">L1: 1 - Europe; L2: 14 - Eastern Europe; L3: Ukraine (UKR); L4:</xsl:when>
          <xsl:when test="$pRegion=''ALG''">L1: 2 - Africa; L2: 20 - Northern Africa; L3: Algeria (ALG); L4:</xsl:when>
          <xsl:when test="$pRegion=''EGY''">L1: 2 - Africa; L2: 20 - Northern Africa; L3: Egypt (EGY); L4:</xsl:when>
          <xsl:when test="$pRegion=''LBY''">L1: 2 - Africa; L2: 20 - Northern Africa; L3: Libya (LBY); L4:</xsl:when>
          <xsl:when test="$pRegion=''MOR''">L1: 2 - Africa; L2: 20 - Northern Africa; L3: Morocco (MOR); L4:</xsl:when>
          <xsl:when test="$pRegion=''TUN''">L1: 2 - Africa; L2: 20 - Northern Africa; L3: Tunisia (TUN); L4:</xsl:when>
          <xsl:when test="$pRegion=''WSA''">L1: 2 - Africa; L2: 20 - Northern Africa; L3: Western Sahara (WSA); L4:</xsl:when>
          <xsl:when test="$pRegion=''AZO''">L1: 2 - Africa; L2: 21 - Macaronesia; L3: Azores (AZO); L4:</xsl:when>
          <xsl:when test="$pRegion=''CNY''">L1: 2 - Africa; L2: 21 - Macaronesia; L3: Canary Is. (CNY); L4:</xsl:when>
          <xsl:when test="$pRegion=''CVI''">L1: 2 - Africa; L2: 21 - Macaronesia; L3: Cape Verde (CVI); L4:</xsl:when>
          <xsl:when test="$pRegion=''MDR''">L1: 2 - Africa; L2: 21 - Macaronesia; L3: Madeira (MDR); L4:</xsl:when>
          <xsl:when test="$pRegion=''SEL''">L1: 2 - Africa; L2: 21 - Macaronesia; L3: Selvagens (SEL); L4:</xsl:when>
          <xsl:when test="$pRegion=''BEN''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Benin (BEN); L4:</xsl:when>
          <xsl:when test="$pRegion=''BKN''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Burkina (BKN); L4:</xsl:when>
          <xsl:when test="$pRegion=''GAM''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Gambia, The (GAM); L4:</xsl:when>
          <xsl:when test="$pRegion=''GHA''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Ghana (GHA); L4:</xsl:when>
          <xsl:when test="$pRegion=''GNB''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Guinea-Bissau (GNB); L4:</xsl:when>
          <xsl:when test="$pRegion=''GUI''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Guinea (GUI); L4:</xsl:when>
          <xsl:when test="$pRegion=''IVO''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Ivory Coast (IVO); L4:</xsl:when>
          <xsl:when test="$pRegion=''LBR''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Liberia (LBR); L4:</xsl:when>
          <xsl:when test="$pRegion=''MLI''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Mali (MLI); L4:</xsl:when>
          <xsl:when test="$pRegion=''MTN''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Mauritania (MTN); L4:</xsl:when>
          <xsl:when test="$pRegion=''NGA''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Nigeria (NGA); L4:</xsl:when>
          <xsl:when test="$pRegion=''NGR''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Niger (NGR); L4:</xsl:when>
          <xsl:when test="$pRegion=''SEN''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Senegal (SEN); L4:</xsl:when>
          <xsl:when test="$pRegion=''SIE''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Sierra Leone (SIE); L4:</xsl:when>
          <xsl:when test="$pRegion=''TOG''">L1: 2 - Africa; L2: 22 - West Tropical Africa; L3: Togo (TOG); L4:</xsl:when>
          <xsl:when test="$pRegion=''BUR''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Burundi (BUR); L4:</xsl:when>
          <xsl:when test="$pRegion=''CAB''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Cabinda (CAB); L4:</xsl:when>
          <xsl:when test="$pRegion=''CAF''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Central African Republic (CAF); L4:</xsl:when>
          <xsl:when test="$pRegion=''CMN''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Cameroon (CMN); L4:</xsl:when>
          <xsl:when test="$pRegion=''CON''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Congo (CON); L4:</xsl:when>
          <xsl:when test="$pRegion=''EQG''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Equatorial Guinea (EQG); L4:</xsl:when>
          <xsl:when test="$pRegion=''GAB''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Gabon (GAB); L4:</xsl:when>
          <xsl:when test="$pRegion=''GGI''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Gulf of Guinea Is. (GGI); L4:</xsl:when>
          <xsl:when test="$pRegion=''RWA''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Rwanda (RWA); L4:</xsl:when>
          <xsl:when test="$pRegion=''ZAI''">L1: 2 - Africa; L2: 23 - West-Central Tropical Africa; L3: Zaire (ZAI); L4:</xsl:when>
          <xsl:when test="$pRegion=''CHA''">L1: 2 - Africa; L2: 24 - Northeast Tropical Africa; L3: Chad (CHA); L4:</xsl:when>
          <xsl:when test="$pRegion=''DJI''">L1: 2 - Africa; L2: 24 - Northeast Tropical Africa; L3: Djibouti (DJI); L4:</xsl:when>
          <xsl:when test="$pRegion=''ERI''">L1: 2 - Africa; L2: 24 - Northeast Tropical Africa; L3: Eritrea (ERI); L4:</xsl:when>
          <xsl:when test="$pRegion=''ETH''">L1: 2 - Africa; L2: 24 - Northeast Tropical Africa; L3: Ethiopia (ETH); L4:</xsl:when>
          <xsl:when test="$pRegion=''SOC''">L1: 2 - Africa; L2: 24 - Northeast Tropical Africa; L3: Socotra (SOC); L4:</xsl:when>
          <xsl:when test="$pRegion=''SOM''">L1: 2 - Africa; L2: 24 - Northeast Tropical Africa; L3: Somalia (SOM); L4:</xsl:when>
          <xsl:when test="$pRegion=''SUD''">L1: 2 - Africa; L2: 24 - Northeast Tropical Africa; L3: Sudan (SUD); L4:</xsl:when>
          <xsl:when test="$pRegion=''KEN''">L1: 2 - Africa; L2: 25 - East Tropical Africa; L3: Kenya (KEN); L4:</xsl:when>
          <xsl:when test="$pRegion=''TAN''">L1: 2 - Africa; L2: 25 - East Tropical Africa; L3: Tanzania (TAN); L4:</xsl:when>
          <xsl:when test="$pRegion=''UGA''">L1: 2 - Africa; L2: 25 - East Tropical Africa; L3: Uganda (UGA); L4:</xsl:when>
          <xsl:when test="$pRegion=''ANG''">L1: 2 - Africa; L2: 26 - South Tropical Africa; L3: Angola (ANG); L4:</xsl:when>
          <xsl:when test="$pRegion=''MLW''">L1: 2 - Africa; L2: 26 - South Tropical Africa; L3: Malawi (MLW); L4:</xsl:when>
          <xsl:when test="$pRegion=''MOZ''">L1: 2 - Africa; L2: 26 - South Tropical Africa; L3: Mozambique (MOZ); L4:</xsl:when>
          <xsl:when test="$pRegion=''ZAM''">L1: 2 - Africa; L2: 26 - South Tropical Africa; L3: Zambia (ZAM); L4:</xsl:when>
          <xsl:when test="$pRegion=''ZIM''">L1: 2 - Africa; L2: 26 - South Tropical Africa; L3: Zimbabwe (ZIM); L4:</xsl:when>
          <xsl:when test="$pRegion=''BOT''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Botswana (BOT); L4:</xsl:when>
          <xsl:when test="$pRegion=''CPP''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Cape Provinces (CPP); L4:</xsl:when>
          <xsl:when test="$pRegion=''CPV''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Caprivi Strip (CPV); L4:</xsl:when>
          <xsl:when test="$pRegion=''LES''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Lesotho (LES); L4:</xsl:when>
          <xsl:when test="$pRegion=''NAM''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Namibia (NAM); L4:</xsl:when>
          <xsl:when test="$pRegion=''NAT''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: KwaZulu-Natal (NAT); L4:</xsl:when>
          <xsl:when test="$pRegion=''OFS''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Free State (OFS); L4:</xsl:when>
          <xsl:when test="$pRegion=''SWZ''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Swaziland (SWZ); L4:</xsl:when>
          <xsl:when test="$pRegion=''TVL''">L1: 2 - Africa; L2: 27 - Southern Africa; L3: Northern Provinces (TVL); L4:</xsl:when>
          <xsl:when test="$pRegion=''ASC''">L1: 2 - Africa; L2: 28 - Middle Atlantic Ocean; L3: Ascension (ASC); L4:</xsl:when>
          <xsl:when test="$pRegion=''STH''">L1: 2 - Africa; L2: 28 - Middle Atlantic Ocean; L3: St.Helena (STH); L4:</xsl:when>
          <xsl:when test="$pRegion=''ALD''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Aldabra (ALD); L4:</xsl:when>
          <xsl:when test="$pRegion=''CGS''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Chagos Archipelago (CGS); L4:</xsl:when>
          <xsl:when test="$pRegion=''COM''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Comoros (COM); L4:</xsl:when>
          <xsl:when test="$pRegion=''MAU''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Mauritius (MAU); L4:</xsl:when>
          <xsl:when test="$pRegion=''MCI''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Mozambique Channel Is. (MCI); L4:</xsl:when>
          <xsl:when test="$pRegion=''MDG''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Madagascar (MDG); L4:</xsl:when>
          <xsl:when test="$pRegion=''REU''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Réunion (REU); L4:</xsl:when>
          <xsl:when test="$pRegion=''ROD''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Rodrigues (ROD); L4:</xsl:when>
          <xsl:when test="$pRegion=''SEY''">L1: 2 - Africa; L2: 29 - Western Indian Ocean; L3: Seychelles (SEY); L4:</xsl:when>
          <xsl:when test="$pRegion=''ALT''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: Altay (ALT); L4:</xsl:when>
          <xsl:when test="$pRegion=''BRY''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: Buryatiya (BRY); L4:</xsl:when>
          <xsl:when test="$pRegion=''CTA''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: Chita (CTA); L4:</xsl:when>
          <xsl:when test="$pRegion=''IRK''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: Irkutsk (IRK); L4:</xsl:when>
          <xsl:when test="$pRegion=''KRA''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: Krasnoyarsk (KRA); L4:</xsl:when>
          <xsl:when test="$pRegion=''TVA''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: Tuva (TVA); L4:</xsl:when>
          <xsl:when test="$pRegion=''WSB''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: West Siberia (WSB); L4:</xsl:when>
          <xsl:when test="$pRegion=''YAK''">L1: 3 - Asia-Temperate; L2: 30 - Siberia; L3: Yakutskiya (YAK); L4:</xsl:when>
          <xsl:when test="$pRegion=''AMU''">L1: 3 - Asia-Temperate; L2: 31 - Russian Far East; L3: Amur (AMU); L4:</xsl:when>
          <xsl:when test="$pRegion=''KAM''">L1: 3 - Asia-Temperate; L2: 31 - Russian Far East; L3: Kamchatka (KAM); L4:</xsl:when>
          <xsl:when test="$pRegion=''KHA''">L1: 3 - Asia-Temperate; L2: 31 - Russian Far East; L3: Khabarovsk (KHA); L4:</xsl:when>
          <xsl:when test="$pRegion=''KUR''">L1: 3 - Asia-Temperate; L2: 31 - Russian Far East; L3: Kuril Is. (KUR); L4:</xsl:when>
          <xsl:when test="$pRegion=''MAG''">L1: 3 - Asia-Temperate; L2: 31 - Russian Far East; L3: Magadan (MAG); L4:</xsl:when>
          <xsl:when test="$pRegion=''PRM''">L1: 3 - Asia-Temperate; L2: 31 - Russian Far East; L3: Primorye (PRM); L4:</xsl:when>
          <xsl:when test="$pRegion=''SAK''">L1: 3 - Asia-Temperate; L2: 31 - Russian Far East; L3: Sakhalin (SAK); L4:</xsl:when>
          <xsl:when test="$pRegion=''KAZ''">L1: 3 - Asia-Temperate; L2: 32 - Middle Asia; L3: Kazakhstan (KAZ); L4:</xsl:when>
          <xsl:when test="$pRegion=''KGZ''">L1: 3 - Asia-Temperate; L2: 32 - Middle Asia; L3: Kirgizistan (KGZ); L4:</xsl:when>
          <xsl:when test="$pRegion=''TKM''">L1: 3 - Asia-Temperate; L2: 32 - Middle Asia; L3: Turkmenistan (TKM); L4:</xsl:when>
          <xsl:when test="$pRegion=''TZK''">L1: 3 - Asia-Temperate; L2: 32 - Middle Asia; L3: Tadzhikistan (TZK); L4:</xsl:when>
          <xsl:when test="$pRegion=''UZB''">L1: 3 - Asia-Temperate; L2: 32 - Middle Asia; L3: Uzbekistan (UZB); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''AFG''">L1: 3 - Asia-Temperate; L2: 34 - Western Asia; L3: Afghanistan (AFG); L4:</xsl:when>
          <xsl:when test="$pRegion=''CYP''">L1: 3 - Asia-Temperate; L2: 34 - Western Asia; L3: Cyprus (CYP); L4:</xsl:when>
          <xsl:when test="$pRegion=''EAI''">L1: 3 - Asia-Temperate; L2: 34 - Western Asia; L3: East Aegean Is. (EAI); L4:</xsl:when>
          <xsl:when test="$pRegion=''IRN''">L1: 3 - Asia-Temperate; L2: 34 - Western Asia; L3: Iran (IRN); L4:</xsl:when>
          <xsl:when test="$pRegion=''IRQ''">L1: 3 - Asia-Temperate; L2: 34 - Western Asia; L3: Iraq (IRQ); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''SIN''">L1: 3 - Asia-Temperate; L2: 34 - Western Asia; L3: Sinai (SIN); L4:</xsl:when>
          <xsl:when test="$pRegion=''TUR''">L1: 3 - Asia-Temperate; L2: 34 - Western Asia; L3: Turkey (TUR); L4:</xsl:when>
          <xsl:when test="$pRegion=''GST''">L1: 3 - Asia-Temperate; L2: 35 - Arabian Peninsula; L3: Gulf States (GST); L4:</xsl:when>
          <xsl:when test="$pRegion=''KUW''">L1: 3 - Asia-Temperate; L2: 35 - Arabian Peninsula; L3: Kuwait (KUW); L4:</xsl:when>
          <xsl:when test="$pRegion=''OMA''">L1: 3 - Asia-Temperate; L2: 35 - Arabian Peninsula; L3: Oman (OMA); L4:</xsl:when>
          <xsl:when test="$pRegion=''SAU''">L1: 3 - Asia-Temperate; L2: 35 - Arabian Peninsula; L3: Saudi Arabia (SAU); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''CHH''">L1: 3 - Asia-Temperate; L2: 36 - China; L3: Hainan (CHH); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''CHQ''">L1: 3 - Asia-Temperate; L2: 36 - China; L3: Qinghai (CHQ); L4:</xsl:when>
          <xsl:when test="$pRegion=''CHS''">L1: 3 - Asia-Temperate; L2: 36 - China; L3: China Southeast (CHS); L4:</xsl:when>
          <xsl:when test="$pRegion=''CHT''">L1: 3 - Asia-Temperate; L2: 36 - China; L3: Tibet (CHT); L4:</xsl:when>
          <xsl:when test="$pRegion=''CHX''">L1: 3 - Asia-Temperate; L2: 36 - China; L3: Xinjiang (CHX); L4:</xsl:when>
          <xsl:when test="$pRegion=''MON''">L1: 3 - Asia-Temperate; L2: 37 - Mongolia; L3: Mongolia (MON); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''KZN''">L1: 3 - Asia-Temperate; L2: 38 - Eastern Asia; L3: Kazan-retto (KZN); L4:</xsl:when>
          <xsl:when test="$pRegion=''NNS''">L1: 3 - Asia-Temperate; L2: 38 - Eastern Asia; L3: Nansei-shoto (NNS); L4:</xsl:when>
          <xsl:when test="$pRegion=''OGA''">L1: 3 - Asia-Temperate; L2: 38 - Eastern Asia; L3: Ogasawara-shoto (OGA); L4:</xsl:when>
          <xsl:when test="$pRegion=''TAI''">L1: 3 - Asia-Temperate; L2: 38 - Eastern Asia; L3: Taiwan (TAI); L4:</xsl:when>
          <xsl:when test="$pRegion=''ASS''">L1: 4 - Asia-Tropical; L2: 40 - Indian Subcontinent; L3: Assam (ASS); L4:</xsl:when>
          <xsl:when test="$pRegion=''BAN''">L1: 4 - Asia-Tropical; L2: 40 - Indian Subcontinent; L3: Bangladesh (BAN); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''LDV''">L1: 4 - Asia-Tropical; L2: 40 - Indian Subcontinent; L3: Laccadive Is. (LDV); L4:</xsl:when>
          <xsl:when test="$pRegion=''MDV''">L1: 4 - Asia-Tropical; L2: 40 - Indian Subcontinent; L3: Maldives (MDV); L4:</xsl:when>
          <xsl:when test="$pRegion=''NEP''">L1: 4 - Asia-Tropical; L2: 40 - Indian Subcontinent; L3: Nepal (NEP); L4:</xsl:when>
          <xsl:when test="$pRegion=''PAK''">L1: 4 - Asia-Tropical; L2: 40 - Indian Subcontinent; L3: Pakistan (PAK); L4:</xsl:when>
          <xsl:when test="$pRegion=''SRL''">L1: 4 - Asia-Tropical; L2: 40 - Indian Subcontinent; L3: Sri Lanka (SRL); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''CBD''">L1: 4 - Asia-Tropical; L2: 41 - Indo-China; L3: Cambodia (CBD); L4:</xsl:when>
          <xsl:when test="$pRegion=''LAO''">L1: 4 - Asia-Tropical; L2: 41 - Indo-China; L3: Laos (LAO); L4:</xsl:when>
          <xsl:when test="$pRegion=''MYA''">L1: 4 - Asia-Tropical; L2: 41 - Indo-China; L3: Myanmar (MYA); L4:</xsl:when>
          <xsl:when test="$pRegion=''NCB''">L1: 4 - Asia-Tropical; L2: 41 - Indo-China; L3: Nicobar Is. (NCB); L4:</xsl:when>
          <xsl:when test="$pRegion=''SCS''">L1: 4 - Asia-Tropical; L2: 41 - Indo-China; L3: South China Sea (SCS); L4:</xsl:when>
          <xsl:when test="$pRegion=''THA''">L1: 4 - Asia-Tropical; L2: 41 - Indo-China; L3: Thailand (THA); L4:</xsl:when>
          <xsl:when test="$pRegion=''VIE''">L1: 4 - Asia-Tropical; L2: 41 - Indo-China; L3: Vietnam (VIE); L4:</xsl:when>
          <xsl:when test="$pRegion=''BOR''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Borneo (BOR); L4:</xsl:when>
          <xsl:when test="$pRegion=''CKI''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Cocos (Keeling) Is. (CKI); L4:</xsl:when>
          <xsl:when test="$pRegion=''JAW''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Jawa (JAW); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''MOL''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Maluku (MOL); L4:</xsl:when>
          <xsl:when test="$pRegion=''PHI''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Philippines (PHI); L4:</xsl:when>
          <xsl:when test="$pRegion=''SUL''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Sulawesi (SUL); L4:</xsl:when>
          <xsl:when test="$pRegion=''SUM''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Sumatera (SUM); L4:</xsl:when>
          <xsl:when test="$pRegion=''XMS''">L1: 4 - Asia-Tropical; L2: 42 - Malesia; L3: Christmas I. (XMS); L4:</xsl:when>
          <xsl:when test="$pRegion=''BIS''">L1: 4 - Asia-Tropical; L2: 43 - Papuasia; L3: Bismarck Archipelago (BIS); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''NTA''">L1: 5 - Australasia; L2: 50 - Australia; L3: Northern Territory (NTA); L4:</xsl:when>
          <xsl:when test="$pRegion=''QLD''">L1: 5 - Australasia; L2: 50 - Australia; L3: Queensland (QLD); L4:</xsl:when>
          <xsl:when test="$pRegion=''SOA''">L1: 5 - Australasia; L2: 50 - Australia; L3: South Australia (SOA); L4:</xsl:when>
          <xsl:when test="$pRegion=''TAS''">L1: 5 - Australasia; L2: 50 - Australia; L3: Tasmania (TAS); L4:</xsl:when>
          <xsl:when test="$pRegion=''VIC''">L1: 5 - Australasia; L2: 50 - Australia; L3: Victoria (VIC); L4:</xsl:when>
          <xsl:when test="$pRegion=''WAU''">L1: 5 - Australasia; L2: 50 - Australia; L3: Western Australia (WAU); L4:</xsl:when>
          <xsl:when test="$pRegion=''ATP''">L1: 5 - Australasia; L2: 51 - New Zealand; L3: Antipodean Is. (ATP); L4:</xsl:when>
          <xsl:when test="$pRegion=''CTM''">L1: 5 - Australasia; L2: 51 - New Zealand; L3: Chatham Is. (CTM); L4:</xsl:when>
          <xsl:when test="$pRegion=''KER''">L1: 5 - Australasia; L2: 51 - New Zealand; L3: Kermadec Is. (KER); L4:</xsl:when>
          <xsl:when test="$pRegion=''NZN''">L1: 5 - Australasia; L2: 51 - New Zealand; L3: New Zealand North (NZN); L4:</xsl:when>
          <xsl:when test="$pRegion=''NZS''">L1: 5 - Australasia; L2: 51 - New Zealand; L3: New Zealand South (NZS); L4:</xsl:when>
          <xsl:when test="$pRegion=''FIJ''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Fiji (FIJ); L4:</xsl:when>
          <xsl:when test="$pRegion=''GIL''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Gilbert Is. (GIL); L4:</xsl:when>
          <xsl:when test="$pRegion=''HBI''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Howland-Baker Is. (HBI); L4:</xsl:when>
          <xsl:when test="$pRegion=''NRU''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Nauru (NRU); L4:</xsl:when>
          <xsl:when test="$pRegion=''NUE''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Niue (NUE); L4:</xsl:when>
          <xsl:when test="$pRegion=''NWC''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: New Caledonia (NWC); L4:</xsl:when>
          <xsl:when test="$pRegion=''PHX''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Phoenix Is. (PHX); L4:</xsl:when>
          <xsl:when test="$pRegion=''SAM''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Samoa (SAM); L4:</xsl:when>
          <xsl:when test="$pRegion=''SCZ''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Santa Cruz Is. (SCZ); L4:</xsl:when>
          <xsl:when test="$pRegion=''TOK''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Tokelau-Manihiki (TOK); L4:</xsl:when>
          <xsl:when test="$pRegion=''TON''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Tonga (TON); L4:</xsl:when>
          <xsl:when test="$pRegion=''TUV''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Tuvalu (TUV); L4:</xsl:when>
          <xsl:when test="$pRegion=''VAN''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Vanuatu (VAN); L4:</xsl:when>
          <xsl:when test="$pRegion=''WAL''">L1: 6 - Pacific; L2: 60 - Southwestern Pacific; L3: Wallis-Futuna Is. (WAL); L4:</xsl:when>
          <xsl:when test="$pRegion=''COO''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Cook Is. (COO); L4:</xsl:when>
          <xsl:when test="$pRegion=''EAS''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Easter Is. (EAS); L4:</xsl:when>
          <xsl:when test="$pRegion=''LIN''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Line Is. (LIN); L4:</xsl:when>
          <xsl:when test="$pRegion=''MRQ''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Marquesas (MRQ); L4:</xsl:when>
          <xsl:when test="$pRegion=''PIT''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Pitcairn Is. (PIT); L4:</xsl:when>
          <xsl:when test="$pRegion=''SCI''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Society Is. (SCI); L4:</xsl:when>
          <xsl:when test="$pRegion=''TUA''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Tuamotu (TUA); L4:</xsl:when>
          <xsl:when test="$pRegion=''TUB''">L1: 6 - Pacific; L2: 61 - South-Central Pacific; L3: Tubuai Is. (TUB); L4:</xsl:when>
          <xsl:when test="$pRegion=''CRL''">L1: 6 - Pacific; L2: 62 - Northwestern Pacific; L3: Caroline Is. (CRL); L4:</xsl:when>
          <xsl:when test="$pRegion=''MCS''">L1: 6 - Pacific; L2: 62 - Northwestern Pacific; L3: Marcus I. (MCS); L4:</xsl:when>
          <xsl:when test="$pRegion=''MRN''">L1: 6 - Pacific; L2: 62 - Northwestern Pacific; L3: Marianas (MRN); L4:</xsl:when>
          <xsl:when test="$pRegion=''MRS''">L1: 6 - Pacific; L2: 62 - Northwestern Pacific; L3: Marshall Is. (MRS); L4:</xsl:when>
          <xsl:when test="$pRegion=''WAK''">L1: 6 - Pacific; L2: 62 - Northwestern Pacific; L3: Wake I. (WAK); L4:</xsl:when>
          <xsl:when test="$pRegion=''HAW''">L1: 6 - Pacific; L2: 63 - North-Central Pacific; L3: Hawaii (HAW); L4:</xsl:when>
          <xsl:when test="$pRegion=''ALU''">L1: 7 - Northern America; L2: 70 - Subarctic America; L3: Aleutian Is. (ALU); L4:</xsl:when>
          <xsl:when test="$pRegion=''ASK''">L1: 7 - Northern America; L2: 70 - Subarctic America; L3: Alaska (ASK); L4:</xsl:when>
          <xsl:when test="$pRegion=''GNL''">L1: 7 - Northern America; L2: 70 - Subarctic America; L3: Greenland (GNL); L4:</xsl:when>
          <xsl:when test="$pRegion=''NUN''">L1: 7 - Northern America; L2: 70 - Subarctic America; L3: Nunavut (NUN); L4:</xsl:when>
          <xsl:when test="$pRegion=''NWT''">L1: 7 - Northern America; L2: 70 - Subarctic America; L3: Northwest Territories (NWT); L4:</xsl:when>
          <xsl:when test="$pRegion=''YUK''">L1: 7 - Northern America; L2: 70 - Subarctic America; L3: Yukon (YUK); L4:</xsl:when>
          <xsl:when test="$pRegion=''ABT''">L1: 7 - Northern America; L2: 71 - Western Canada; L3: Alberta (ABT); L4:</xsl:when>
          <xsl:when test="$pRegion=''BRC''">L1: 7 - Northern America; L2: 71 - Western Canada; L3: British Columbia (BRC); L4:</xsl:when>
          <xsl:when test="$pRegion=''MAN''">L1: 7 - Northern America; L2: 71 - Western Canada; L3: Manitoba (MAN); L4:</xsl:when>
          <xsl:when test="$pRegion=''SAS''">L1: 7 - Northern America; L2: 71 - Western Canada; L3: Saskatchewan (SAS); L4:</xsl:when>
          <xsl:when test="$pRegion=''LAB''">L1: 7 - Northern America; L2: 72 - Eastern Canada; L3: Labrador (LAB); L4:</xsl:when>
          <xsl:when test="$pRegion=''NBR''">L1: 7 - Northern America; L2: 72 - Eastern Canada; L3: New Brunswick (NBR); L4:</xsl:when>
          <xsl:when test="$pRegion=''NFL''">L1: 7 - Northern America; L2: 72 - Eastern Canada; L3: Newfoundland (NFL); L4:</xsl:when>
          <xsl:when test="$pRegion=''NSC''">L1: 7 - Northern America; L2: 72 - Eastern Canada; L3: Nova Scotia (NSC); L4:</xsl:when>
          <xsl:when test="$pRegion=''ONT''">L1: 7 - Northern America; L2: 72 - Eastern Canada; L3: Ontario (ONT); L4:</xsl:when>
          <xsl:when test="$pRegion=''PEI''">L1: 7 - Northern America; L2: 72 - Eastern Canada; L3: Prince Edward I. (PEI); L4:</xsl:when>
          <xsl:when test="$pRegion=''QUE''">L1: 7 - Northern America; L2: 72 - Eastern Canada; L3: Québec (QUE); L4:</xsl:when>
          <xsl:when test="$pRegion=''COL''">L1: 7 - Northern America; L2: 73 - Northwestern U.S.A.; L3: Colorado (COL); L4:</xsl:when>
          <xsl:when test="$pRegion=''IDA''">L1: 7 - Northern America; L2: 73 - Northwestern U.S.A.; L3: Idaho (IDA); L4:</xsl:when>
          <xsl:when test="$pRegion=''MNT''">L1: 7 - Northern America; L2: 73 - Northwestern U.S.A.; L3: Montana (MNT); L4:</xsl:when>
          <xsl:when test="$pRegion=''ORE''">L1: 7 - Northern America; L2: 73 - Northwestern U.S.A.; L3: Oregon (ORE); L4:</xsl:when>
          <xsl:when test="$pRegion=''WAS''">L1: 7 - Northern America; L2: 73 - Northwestern U.S.A.; L3: Washington (WAS); L4:</xsl:when>
          <xsl:when test="$pRegion=''WYO''">L1: 7 - Northern America; L2: 73 - Northwestern U.S.A.; L3: Wyoming (WYO); L4:</xsl:when>
          <xsl:when test="$pRegion=''ILL''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Illinois (ILL); L4:</xsl:when>
          <xsl:when test="$pRegion=''IOW''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Iowa (IOW); L4:</xsl:when>
          <xsl:when test="$pRegion=''KAN''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Kansas (KAN); L4:</xsl:when>
          <xsl:when test="$pRegion=''MIN''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Minnesota (MIN); L4:</xsl:when>
          <xsl:when test="$pRegion=''MSO''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Missouri (MSO); L4:</xsl:when>
          <xsl:when test="$pRegion=''NDA''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: North Dakota (NDA); L4:</xsl:when>
          <xsl:when test="$pRegion=''NEB''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Nebraska (NEB); L4:</xsl:when>
          <xsl:when test="$pRegion=''OKL''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Oklahoma (OKL); L4:</xsl:when>
          <xsl:when test="$pRegion=''SDA''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: South Dakota (SDA); L4:</xsl:when>
          <xsl:when test="$pRegion=''WIS''">L1: 7 - Northern America; L2: 74 - North-Central U.S.A.; L3: Wisconsin (WIS); L4:</xsl:when>
          <xsl:when test="$pRegion=''CNT''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Connecticut (CNT); L4:</xsl:when>
          <xsl:when test="$pRegion=''INI''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Indiana (INI); L4:</xsl:when>
          <xsl:when test="$pRegion=''MAI''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Maine (MAI); L4:</xsl:when>
          <xsl:when test="$pRegion=''MAS''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Masachusettes (MAS); L4:</xsl:when>
          <xsl:when test="$pRegion=''MIC''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Michigan (MIC); L4:</xsl:when>
          <xsl:when test="$pRegion=''NWH''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: New Hampshire (NWH); L4:</xsl:when>
          <xsl:when test="$pRegion=''NWJ''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: New Jersey (NWJ); L4:</xsl:when>
          <xsl:when test="$pRegion=''NWY''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: New York (NWY); L4:</xsl:when>
          <xsl:when test="$pRegion=''OHI''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Ohio (OHI); L4:</xsl:when>
          <xsl:when test="$pRegion=''PEN''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Pennsylvania (PEN); L4:</xsl:when>
          <xsl:when test="$pRegion=''RHO''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Rhode I. (RHO); L4:</xsl:when>
          <xsl:when test="$pRegion=''VER''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: Vermont (VER); L4:</xsl:when>
          <xsl:when test="$pRegion=''WVA''">L1: 7 - Northern America; L2: 75 - Northeastern U.S.A.; L3: West Virginia (WVA); L4:</xsl:when>
          <xsl:when test="$pRegion=''ARI''">L1: 7 - Northern America; L2: 76 - Southwestern U.S.A.; L3: Arizona (ARI); L4:</xsl:when>
          <xsl:when test="$pRegion=''CAL''">L1: 7 - Northern America; L2: 76 - Southwestern U.S.A.; L3: California (CAL); L4:</xsl:when>
          <xsl:when test="$pRegion=''NEV''">L1: 7 - Northern America; L2: 76 - Southwestern U.S.A.; L3: Nevada (NEV); L4:</xsl:when>
          <xsl:when test="$pRegion=''UTA''">L1: 7 - Northern America; L2: 76 - Southwestern U.S.A.; L3: Utah (UTA); L4:</xsl:when>
          <xsl:when test="$pRegion=''NWM''">L1: 7 - Northern America; L2: 77 - South-Central U.S.A.; L3: New Mexico (NWM); L4:</xsl:when>
          <xsl:when test="$pRegion=''TEX''">L1: 7 - Northern America; L2: 77 - South-Central U.S.A.; L3: Texas (TEX); L4:</xsl:when>
          <xsl:when test="$pRegion=''ALA''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Alabama (ALA); L4:</xsl:when>
          <xsl:when test="$pRegion=''ARK''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Arkansas (ARK); L4:</xsl:when>
          <xsl:when test="$pRegion=''DEL''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Delaware (DEL); L4:</xsl:when>
          <xsl:when test="$pRegion=''FLA''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Florida (FLA); L4:</xsl:when>
          <xsl:when test="$pRegion=''GEO''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Georgia (GEO); L4:</xsl:when>
          <xsl:when test="$pRegion=''KTY''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Kentucky (KTY); L4:</xsl:when>
          <xsl:when test="$pRegion=''LOU''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Louisiana (LOU); L4:</xsl:when>
          <xsl:when test="$pRegion=''MRY''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Maryland (MRY); L4:</xsl:when>
          <xsl:when test="$pRegion=''MSI''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Mississippi (MSI); L4:</xsl:when>
          <xsl:when test="$pRegion=''NCA''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: North Carolina (NCA); L4:</xsl:when>
          <xsl:when test="$pRegion=''SCA''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: South Carolina (SCA); L4:</xsl:when>
          <xsl:when test="$pRegion=''TEN''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Tennessee (TEN); L4:</xsl:when>
          <xsl:when test="$pRegion=''VRG''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: Virginia (VRG); L4:</xsl:when>
          <xsl:when test="$pRegion=''WDC''">L1: 7 - Northern America; L2: 78 - Southeastern U.S.A.; L3: District of Columbia (WDC); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''MXG''">L1: 7 - Northern America; L2: 79 - Mexico; L3: Mexico Gulf (MXG); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''BLZ''">L1: 8 - Southern America; L2: 80 - Central America; L3: Belize (BLZ); L4:</xsl:when>
          <xsl:when test="$pRegion=''COS''">L1: 8 - Southern America; L2: 80 - Central America; L3: Costa Rica (COS); L4:</xsl:when>
          <xsl:when test="$pRegion=''CPI''">L1: 8 - Southern America; L2: 80 - Central America; L3: Central American Pacific Is. (CPI); L4:</xsl:when>
          <xsl:when test="$pRegion=''ELS''">L1: 8 - Southern America; L2: 80 - Central America; L3: El Salvador (ELS); L4:</xsl:when>
          <xsl:when test="$pRegion=''GUA''">L1: 8 - Southern America; L2: 80 - Central America; L3: Guatemala (GUA); L4:</xsl:when>
          <xsl:when test="$pRegion=''HON''">L1: 8 - Southern America; L2: 80 - Central America; L3: Honduras (HON); L4:</xsl:when>
          <xsl:when test="$pRegion=''NIC''">L1: 8 - Southern America; L2: 80 - Central America; L3: Nicaragua (NIC); L4:</xsl:when>
          <xsl:when test="$pRegion=''PAN''">L1: 8 - Southern America; L2: 80 - Central America; L3: Panamá (PAN); L4:</xsl:when>
          <xsl:when test="$pRegion=''ARU''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Aruba (ARU); L4:</xsl:when>
          <xsl:when test="$pRegion=''BAH''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Bahamas (BAH); L4:</xsl:when>
          <xsl:when test="$pRegion=''BER''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Bermuda (BER); L4:</xsl:when>
          <xsl:when test="$pRegion=''CAY''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Cayman Is. (CAY); L4:</xsl:when>
          <xsl:when test="$pRegion=''CUB''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Cuba (CUB); L4:</xsl:when>
          <xsl:when test="$pRegion=''DOM''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Dominican Republic (DOM); L4:</xsl:when>
          <xsl:when test="$pRegion=''HAI''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Haiti (HAI); L4:</xsl:when>
          <xsl:when test="$pRegion=''JAM''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Jamaica (JAM); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''PUE''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Puerto Rico (PUE); L4:</xsl:when>
          <xsl:when test="$pRegion=''SWC''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Southwest Caribbean (SWC); L4:</xsl:when>
          <xsl:when test="$pRegion=''TCI''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Turks-Caicos Is. (TCI); L4:</xsl:when>
          <xsl:when test="$pRegion=''TRT''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Trinidad-Tobago (TRT); L4:</xsl:when>
          <xsl:when test="$pRegion=''VNA''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Venezuelan Antilles (VNA); L4:</xsl:when>
          <xsl:when test="$pRegion=''WIN''">L1: 8 - Southern America; L2: 81 - Caribbean; L3: Windward Is. (WIN); L4:</xsl:when>
          <xsl:when test="$pRegion=''FRG''">L1: 8 - Southern America; L2: 82 - Northern South America; L3: French Guiana (FRG); L4:</xsl:when>
          <xsl:when test="$pRegion=''GUY''">L1: 8 - Southern America; L2: 82 - Northern South America; L3: Guyana (GUY); L4:</xsl:when>
          <xsl:when test="$pRegion=''SUR''">L1: 8 - Southern America; L2: 82 - Northern South America; L3: Suriname (SUR); L4:</xsl:when>
          <xsl:when test="$pRegion=''VEN''">L1: 8 - Southern America; L2: 82 - Northern South America; L3: Venezuela (VEN); L4:</xsl:when>
          <xsl:when test="$pRegion=''BOL''">L1: 8 - Southern America; L2: 83 - Western South America; L3: Bolivia (BOL); L4:</xsl:when>
          <xsl:when test="$pRegion=''CLM''">L1: 8 - Southern America; L2: 83 - Western South America; L3: Colombia (CLM); L4:</xsl:when>
          <xsl:when test="$pRegion=''ECU''">L1: 8 - Southern America; L2: 83 - Western South America; L3: Ecuador (ECU); L4:</xsl:when>
          <xsl:when test="$pRegion=''GAL''">L1: 8 - Southern America; L2: 83 - Western South America; L3: Galápagos (GAL); L4:</xsl:when>
          <xsl:when test="$pRegion=''PER''">L1: 8 - Southern America; L2: 83 - Western South America; L3: Peru (PER); L4:</xsl:when>
          ...
          <xsl:when test="$pRegion=''DSV''">L1: 8 - Southern America; L2: 85 - Southern South America; L3: Desventurados Is. (DSV); L4:</xsl:when>
          <xsl:when test="$pRegion=''JNF''">L1: 8 - Southern America; L2: 85 - Southern South America; L3: Juan Fernández Is. (JNF); L4:</xsl:when>
          <xsl:when test="$pRegion=''PAR''">L1: 8 - Southern America; L2: 85 - Southern South America; L3: Paraguay (PAR); L4:</xsl:when>
          <xsl:when test="$pRegion=''URU''">L1: 8 - Southern America; L2: 85 - Southern South America; L3: Uruguay (URU); L4:</xsl:when>
          <xsl:when test="$pRegion=''ASP''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Amsterdam-St.Paul Is. (ASP); L4:</xsl:when>
          <xsl:when test="$pRegion=''BOU''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Bouvet I. (BOU); L4:</xsl:when>
          <xsl:when test="$pRegion=''CRZ''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Crozet Is. (CRZ); L4:</xsl:when>
          <xsl:when test="$pRegion=''FAL''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Falkland Is. (FAL); L4:</xsl:when>
          <xsl:when test="$pRegion=''HMD''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Heard-McDonald Is. (HMD); L4:</xsl:when>
          <xsl:when test="$pRegion=''KEG''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Kerguelen (KEG); L4:</xsl:when>
          <xsl:when test="$pRegion=''MAQ''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Macquarie Is. (MAQ); L4:</xsl:when>
          <xsl:when test="$pRegion=''MPE''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Marion-Prince Edward Is. (MPE); L4:</xsl:when>
          <xsl:when test="$pRegion=''SGE''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: South Georgia (SGE); L4:</xsl:when>
          <xsl:when test="$pRegion=''SSA''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: South Sandwich Is. (SSA); L4:</xsl:when>
          <xsl:when test="$pRegion=''TDC''">L1: 9 - Antarctic; L2: 90 - Subantarctic Islands; L3: Tristan da Cunha (TDC); L4:</xsl:when>
          <xsl:when test="$pRegion=''ANT''">L1: 9 - Antarctic; L2: 91 - Antarctic Continent; L3: Antarctica (ANT); L4:</xsl:when>
        </xsl:choose>
      </xsl:when>
...
where TransformationPK = 7


 update tblProviderOtherData 
 set POtherDataUpdatedDate = GETDATE()
 where POtherDataType = 'distribution' 
    ...
    <xsl:choose>
      <xsl:when test="$pOrig=''Indigenous''">
        <xsl:choose>
          ...
          <xsl:otherwise>Origin:  <xsl:value-of select="$pOrig" /> Occurence: <xsl:value-of select="$pOcc" /></xsl:otherwise>
        </xsl:choose>
      </xsl:when>
...
GRANT EXECUTE ON dbo.sprSelect_UnlinkedNames TO [compositae_user]
GRANT EXECUTE ON dbo.dt_getpropertiesbyid_vcs_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderName TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderNameAuthor TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameLSIDs TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UnlinkedNamesCount TO [compositae_user]
GRANT EXECUTE ON dbo.dt_displayoaerror_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_ProviderNameAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReferenceLSIDs TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportProgress TO [compositae_user]
GRANT EXECUTE ON dbo.dt_addtosourcecontrol_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderNameChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderNameAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SearchProviderNames TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UserProviders TO [compositae_user]
GRANT EXECUTE ON dbo.dt_checkinobject_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Author TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportNoParent TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderNameConceptLinks TO [compositae_user]
GRANT EXECUTE ON dbo.dt_checkoutobject_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SearchNames2 TO [compositae_user]
GRANT EXECUTE ON dbo.dt_isundersourcecontrol_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_Author TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_Concept TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_NamesIntegrationOrder TO [compositae_user]
GRANT EXECUTE ON dbo.dt_validateloginparams_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderRISById TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportSimilarNames TO [compositae_user]
GRANT EXECUTE ON dbo.dt_whocheckedout_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderRIS TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_ConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameMatchesTest TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderReferenceChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameWithCombAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RelationshipTypes TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderRIS TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_NameData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderNames TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithProvNameAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertNameRecords TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderRISChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderNameAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithCombAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RunReport TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProvidersForName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ParentProviderName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProvidersForReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderName TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertName TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_LinkedProviderNames TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameMatches TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdateProviderNameLink TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ReferenceRIS TO [compositae_user]
GRANT EXECUTE ON dbo.sprLink_NameParent TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UknownTaxaNode TO [compositae_user]
GRANT EXECUTE ON dbo.sprLink_NamePreferred TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithAuthor TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Ranks TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ImportTypes TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReferencesWithCitation TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithYear TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_AllNamesForUpdate TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderRIS TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ParentAtRank TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReferencesWithPartialCitation TO [compositae_user]
GRANT EXECUTE ON dbo.tmpFixIPNI2 TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ChildrenAtRank TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithMatchParent TO [compositae_user]
GRANT EXECUTE ON dbo.tmpFixIPNI3 TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesAtRankWithAncestor TO [compositae_user]
GRANT EXECUTE ON dbo.tmpFixIPNI4 TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportStatistics TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_MatchParentName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_DuplicateNameReferences TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Reference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportMultipleParentMatches TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConcetps TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_Name TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_Reference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Report TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NoNames TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ReferenceData TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_Deprecated TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReferenceMatches TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RISTypes TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportAllSubordAndSyn TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_Reference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportAllSubords TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_Reference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportConflictingData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SearchProviderRefs TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportDiffMatrix TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportLowMatchScores TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_FieldStatusIdentifiers TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportMultipleMatches TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderRISByReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_FieldStatusLevels TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportSubordAndSyn TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportSubordinates TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_NameRelationships TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderNameLink TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_PCRById TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesForUpdate TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportConflictingAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_Name TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithPartialCanonical TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SearchNames TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithCanonical TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_Name TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ProviderConceptChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithExactCanonical TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Provider TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderNameById TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderRISByReferenceId TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderConcept TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameSynonyms TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_Name TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NodeToRoot TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_SystemProviderConcept TO [compositae_user]
GRANT EXECUTE ON dbo.spriNewTreeState TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ProviderNameChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ProviderReferenceChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameConceptRelationships TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_NameRank TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithPartialYear TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderNameRank TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithParent TO [compositae_user]
GRANT EXECUTE ON dbo.sprGetNode TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NextUnlinkedConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_ProviderReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NextUnlinkedName TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ProviderRISChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NextUnlinkedReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConceptById TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ConceptMatches TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameChildCount TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SearchableFields TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConceptRelationshipById TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_FuzzyNameSearch TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_NameRelationData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UnlinkedReferencesCount TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UnlinkedConceptsCount TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConceptRelationships TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportPhantoms TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelectRoleKeyByRoleName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UnlinkedConcepts TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameEditTrail TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ResetFailedStatus TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SystemProviderConcept TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_Author TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NextUnlinkedConcept TO [compositae_user]
GRANT EXECUTE ON dbo.sprCalculateMatchScore TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ReportError TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SystemProviderConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderNameConcepts TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_NameAuthor TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderReferenceById TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderNameAuthor TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_Concept TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderNameRelationships TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Name TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UnlinkedReferences TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ChildNames TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderConcept TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportNamesList TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderConceptChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprGetClassifications TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_Concept TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Literature_Search3 TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ParentProviderConcept TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderConceptRelationshipChange TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_OtherDataTransformation TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_Reference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Users TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_OtherDataType TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ConceptData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderRISByReferenceGuid TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_MoveNameChildren TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_Transformation TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderReferences TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_LinkedProviderReferences TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderImport TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ConceptRelationshipData TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_CleanDatabase TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_OtherData TO [compositae_user]
GRANT EXECUTE ON dbo.spruGetTreeState TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConcept TO [compositae_user]
GRANT EXECUTE ON dbo.sprSearch_References TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_OtherDataTransformation TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_MergeNameConcepts TO [compositae_user]
GRANT EXECUTE ON dbo.sprLogin TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_OtherDataType TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_NameAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_ProviderOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_SystemProviderRIS TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_StandardOutput TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ReferenceRIS TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_Transformation TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ConsensusXslt TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_Concept TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameRefCitation TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithRank TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderConceptRelationshipStatus TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesInReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderConceptStatus TO [compositae_user]
GRANT EXECUTE ON dbo.spInsertUpdate_FieldStatus TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NextUnlinkedOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderImport TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithRankAndYear TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_FieldStatus_RecordByKeyAndTableName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_OtherDataToUpdate TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_FieldStatus TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_OtherDataTransformations TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameChildren TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_OtherDataTypes TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportUnlinkedRecords TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SystemProviderConceptToName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderImports TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RISMappings TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderNameOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_NameLinkData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderOtherDataTypes TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_SystemProviderConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReferencesForName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameConcepts TO [compositae_user]
GRANT EXECUTE ON dbo.spInsert_FieldStatus TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_ProviderName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConceptData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Transformations TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_ProviderNameRecord TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RISByReference TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UnlinkedOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Authors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_UnlinkedOtherDataCount TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameMappings TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_ProviderOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_StandardOutputUseForConsensus TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_MergedReferenceLinks TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_DataToTransfer TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_OtherData TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithPartialAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_Transformation TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_StandardOutput TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ConceptMappings TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_OtherDataTransformation TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_Concept TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_OtherDataType TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Concept TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SystemProviderNameForName TO [compositae_user]
GRANT EXECUTE ON dbo.dt_generateansiname TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ConceptRelationship TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_SystemProviderRefForRef TO [compositae_user]
GRANT EXECUTE ON dbo.dt_adduserobject TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ConceptRelationshipMappings TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithRankAndCanonical TO [compositae_user]
GRANT EXECUTE ON dbo.dt_setpropertybyid TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderNameMatchScore TO [compositae_user]
GRANT EXECUTE ON dbo.dt_getobjwithprop TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_UnlinkProviderConcepts TO [compositae_user]
GRANT EXECUTE ON dbo.dt_getpropertiesbyid TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderNameConcepts TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConceptRecords TO [compositae_user]
GRANT EXECUTE ON dbo.dt_setpropertybyid_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ConceptLinks TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ProviderConceptRelationshipsForCR TO [compositae_user]
GRANT EXECUTE ON dbo.dt_getobjwithprop_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ProviderConceptLinks TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithPartialAuthorsText TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_Provider TO [compositae_user]
GRANT EXECUTE ON dbo.dt_getpropertiesbyid_u TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ConceptsIntegrationOrder TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithPartialCombAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_Provider TO [compositae_user]
GRANT EXECUTE ON dbo.dt_dropuserobjectbyid TO [compositae_user]
GRANT EXECUTE ON dbo.dt_droppropertiesbyid TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_ReferencesIntegrationOrder TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_Provider TO [compositae_user]
GRANT EXECUTE ON dbo.dt_verstamp006 TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ConceptRelationshipMatches TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsert_OtherDataIntegrationOrder TO [compositae_user]
GRANT EXECUTE ON dbo.dt_verstamp007 TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_ConsensusAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_StandardXmlForConsensus TO [compositae_user]
GRANT EXECUTE ON dbo.dt_getpropertiesbyid_vcs TO [compositae_user]
GRANT EXECUTE ON dbo.dt_displayoaerror TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithDiffPrefParent TO [compositae_user]
GRANT EXECUTE ON dbo.dt_adduserobject_vcs TO [compositae_user]
GRANT EXECUTE ON dbo.sprTransferInsertUpdate_FieldStatus TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_ProviderOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.dt_addtosourcecontrol TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NamesWithSameBasionym TO [compositae_user]
GRANT EXECUTE ON dbo.dt_checkinobject TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RootKey TO [compositae_user]
GRANT EXECUTE ON dbo.dt_checkoutobject TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Providers TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_ReportUnknownParent TO [compositae_user]
GRANT EXECUTE ON dbo.dt_isundersourcecontrol TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Reports TO [compositae_user]
GRANT EXECUTE ON dbo.dt_removefromsourcecontrol TO [compositae_user]
GRANT EXECUTE ON dbo.sprUpdate_CleanOtherData TO [compositae_user]
GRANT EXECUTE ON dbo.dt_validateloginparams TO [compositae_user]
GRANT EXECUTE ON dbo.sprInsertUpdate_NameAuthor TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RankTCS TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_Transformation TO [compositae_user]
GRANT EXECUTE ON dbo.dt_vcsenabled TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_AuthorByName TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_RankSort TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_NameParentMatch TO [compositae_user]
GRANT EXECUTE ON dbo.dt_whocheckedout TO [compositae_user]
GRANT EXECUTE ON dbo.sprDelete_NameAuthors TO [compositae_user]
GRANT EXECUTE ON dbo.sprSelect_LSIDFromDeprecated TO [compositae_user]
