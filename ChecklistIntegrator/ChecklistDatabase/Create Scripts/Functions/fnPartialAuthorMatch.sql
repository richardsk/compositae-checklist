IF EXISTS (SELECT * FROM sysobjects WHERE type = 'FN' AND name = 'fnPartialAuthorMatch')
	BEGIN
		DROP  Function fnPartialAuthorMatch
	END

GO

CREATE Function fnPartialAuthorMatch
(
	@strA nvarchar(1000),
	@strB nvarchar(1000)
)
...
begin
	...
	return dbo.fnLevenshteinPercentWords(@strA, @strB)
...
GRANT EXEC ON fnPartialAuthorMatch TO PUBLIC
