IF EXISTS (SELECT * FROM sysobjects WHERE type = 'FN' AND name = 'fnLevenshteinDistance')
	BEGIN
		DROP  Function dbo.fnLevenshteinDistance
	END
...
GRANT EXEC ON dbo.fnLevenshteinDistance TO PUBLIC
