...
Partial Class Controls_ConsensusControl
    ...
    Public Sub Display()
        ...
        Dim geoList As List(Of DataAccess.TDWGGeo) = d.GetNameDistributionDescendents(SelName.Id)
        ...
        validation.Add(Global.Resources.Resource.Name, DataAccess.Utility.GetValidationImage(pn, "PNNameFull"))
        ...
        If pubText IsNot Nothing AndAlso pubText.Length > 0 Then
            If std Then
                ...
                validation.Add(Global.Resources.Resource.Published, DataAccess.Utility.GetValidationImage(pn, "PNPublishedIn"))
            Else
                Fields.Add(Global.Resources.Resource.PublishedNonStandard, pubText)
                validation.Add(Global.Resources.Resource.PublishedNonStandard, DataAccess.Utility.GetValidationImage(pn, "PNPublishedIn"))
            End If
        End If
        ...
        If SelName.NamePreferredFk = SelName.Id Then
            ...
            Dim lnk As String = "<a style='color:Black' href='" + DataAccess.Utility.GetDefaultPageUrl(Request, "2") + "&nameId=" + SelName.Id + "'>" + Global.Resources.Resource.Concept_According_To + "</a>"
        ...
        ElseIf SelName.NamePreferredFk IsNot Nothing Then
            Fields.Add(Global.Resources.Resource.Status, "<span style='color:Red'>SYNONYM</span> of " + DataAccess.Utility.GetNameLinkHtml(Request, SelName.NamePreferredFk, SelName.NamePreferredFormatted, "0"))
        Else
        ...
        If SelName.NameOrthography IsNot Nothing AndAlso SelName.NameOrthography.Length > 0 Then
            ...
            validation.Add(Global.Resources.Resource.Name_Orthography, DataAccess.Utility.GetValidationImage(pn, "PNOrthography"))
        End If

        If SelName.NameBasionym IsNot Nothing AndAlso SelName.NameBasionym.Length > 0 Then
            Fields.Add(Global.Resources.Resource.Name_Basionym, DataAccess.Utility.GetNameLinkHtml(Request, SelName.NameBasionymFk, SelName.NameBasionymFormatted, "0"))
            validation.Add(Global.Resources.Resource.Name_Basionym, DataAccess.Utility.GetValidationImage(pn, "PNBasionym"))
        End If
        ...
        If SelName.Id = SelName.NamePreferredFk Then
            ...
            For Each sn As Name In syns
                ...
                If sn.Id <> SelName.Id And sn.Id <> SelName.NameBasionymFk Then
                    Dim txt As String = DataAccess.Utility.GetNameLinkHtml(Request, sn.Id, sn.NameFullFormatted, "0")
                    If tmp = 1 Then
        ...
        If SelName.NameTypeName IsNot Nothing AndAlso SelName.NameTypeName.Length > 0 Then
            Fields.Add(Global.Resources.Resource.Name_Type, DataAccess.Utility.GetNameLinkHtml(Request, SelName.NameTypeNameFk, SelName.NameTypeNameFormatted, "0"))
            validation.Add(Global.Resources.Resource.Name_Type, DataAccess.Utility.GetValidationImage(pn, "PNTypeName"))
        End If

        If SelName.NameHomonymOf IsNot Nothing AndAlso SelName.NameHomonymOf.Length > 0 Then
            If SelName.NameHomonymOfFk IsNot Nothing Then
                Fields.Add(Global.Resources.Resource.Homonym_Of, DataAccess.Utility.GetNameLinkHtml(Request, SelName.NameHomonymOfFk, SelName.NameHomonymOfFormatted, "0"))
            Else
                Fields.Add(Global.Resources.Resource.Homonym_Of, SelName.NameHomonymOf)
            End If
            validation.Add(Global.Resources.Resource.Homonym_Of, DataAccess.Utility.GetValidationImage(pn, "PNHomonymOf"))
        End If

        If SelName.NameBasedOn IsNot Nothing AndAlso SelName.NameBasedOn.Length > 0 Then
            Fields.Add(Global.Resources.Resource.Based_On, DataAccess.Utility.GetNameLinkHtml(Request, SelName.NameBasedOnFk, SelName.NameBasedOnFormatted, "0"))
            validation.Add(Global.Resources.Resource.Based_On, DataAccess.Utility.GetValidationImage(pn, "PNBasedOn"))
        End If

        If SelName.NameConservedAgainst IsNot Nothing AndAlso SelName.NameConservedAgainst.Length > 0 Then
            Fields.Add(Global.Resources.Resource.Conserved_Against, DataAccess.Utility.GetNameLinkHtml(Request, SelName.NameConservedAgainstFk, SelName.NameConservedAgainstFormatted, "0"))
            validation.Add(Global.Resources.Resource.Conserved_Against, DataAccess.Utility.GetValidationImage(pn, "PNConservedAgainst"))
        End If

        If SelName.NameReplacementFor IsNot Nothing AndAlso SelName.NameReplacementFor.Length > 0 Then
            Fields.Add(Global.Resources.Resource.Replacement_For, DataAccess.Utility.GetNameLinkHtml(Request, SelName.NameReplacementForFk, SelName.NameReplacementForFormatted, "0"))
            validation.Add(Global.Resources.Resource.Replacement_For, DataAccess.Utility.GetValidationImage(pn, "PNReplacementFor"))
        End If

        If ris IsNot Nothing And pubText <> fullRef And fullRef.Length > 0 Then
            Fields.Add(Global.Resources.Resource.Full_Ref, DataAccess.Utility.GetLiteratureLinkHtml(SelName.NameReferenceFk, fullRef))
        End If
        ...
        If SelName.NameNotes IsNot Nothing AndAlso SelName.NameNotes.Length > 0 Then
            ...
            validation.Add(Global.Resources.Resource.Notes, DataAccess.Utility.GetValidationImage(pn, "PNNotes"))
        End If
        ...
        dataProvLabel.Text = DataAccess.Utility.GetProvidersHtml(provData, DataAccess.Utility.ProviderDataType.Names)
