...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="conRegion">
		...
		<xsl:choose>
			<xsl:when test="$pRegion='Bora Bora'">TDWG Level 4;SCI-OO</xsl:when>
			<xsl:when test="$pRegion='Raiatea'">TDWG Level 4;SCI-OO</xsl:when>
			<xsl:when test="$pRegion='Tahiti'">TDWG Level 4;SCI-OO</xsl:when>
			<xsl:when test="$pRegion='Mehetia'">TDWG Level 4;SCI-OO</xsl:when>
			<xsl:when test="$pRegion='Tahaa'">TDWG Level 4;SCI-OO</xsl:when>
			<xsl:when test="$pRegion='Huahine'">TDWG Level 4;SCI-OO</xsl:when>
